...
public class SlipRingShaftSpeedUpdateS2CPacket implements Packetable {
    
    private final BlockPos target;

    public SlipRingShaftSpeedUpdateS2CPacket(BlockPos target) {
        this.target = target;
    }

    public SlipRingShaftSpeedUpdateS2CPacket(FriendlyByteBuf buf) {
